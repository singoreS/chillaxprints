        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground mt-4">
                <li><strong>Shopify :</strong> notre plateforme e-commerce pour le traitement des commandes</li>
                <li><strong>Transporteurs :</strong> pour la livraison de vos colis (La Poste, Colissimo, etc.)</li>
